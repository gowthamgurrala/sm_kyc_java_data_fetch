...
public class getEntity implements RequestHandler<SQSEvent, Void> {
    ...
    public static Object getDetails(Map<String, Object> jsonData) throws IOException {
        ...
        RequestBody body = RequestBody.create(mediaType, "{\r\n    \"header\": {\r\n        \"formName\": \"FO-006-ITRST\"\r\n    },\r\n    \"serviceName\": \"itrStatusService\",\r\n    \"entityNum\": \"ALGPJ6855K\"\r\n}");
        Request request = new Request.Builder()
                ...
                .addHeader("Cookie", "AuthToken=7e6a668d6f8f4734b9e484801b8f4140")
                .build();
