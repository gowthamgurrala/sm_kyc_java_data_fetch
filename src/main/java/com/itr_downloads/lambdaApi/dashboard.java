...
public class dashboard implements RequestHandler<SQSEvent, Void> {
    ...
    public static Object getDetails(Map<String, Object> jsonData) throws IOException {
        ...
        RequestBody body = RequestBody.create(mediaType, "{\r\n    \"header\": {\r\n        \"formname\": \"FO-013-DSBRD\"\r\n    },\r\n    \"serviceName\": \"dashboardMenuService\",\r\n    \"roleCd\": \"\"\r\n}");
        Request request = new Request.Builder()
                .url("https://eportal.incometax.gov.in/iec/loginapi/auth/dashboard")
                .method("POST", body)
                ...
                .addHeader("Cookie", "AuthToken=c0dca4b683ea42f292bab8fe2705bebe")
                .build();
